...
category: "roguelikes"
game: "Balatro"
tags: ["balatro", "tier-list", "joker", "deckbuilder"]
pubDate: 2026-06-15
updatedDate: 2026-07-03
author: "Sam Reyes"
featured: true
faq:
  - q: "What is the best Joker in Balatro?"
    a: "There is no single best Joker — the strength of any Joker depends on the rest of your build, your deck composition, and the upcoming boss blinds. In the current patch, the highest-impact Jokers are Photograph, Yorick, Blueprint/Brainstorm, and Triboulet, but each requires specific support to be game-winning."
  - q: "Should I sell my base Jokers for the new ones?"
    a: "It depends. Early game, keep your +mult Jokers even if a new rare appears. Late game, selling a basic +mult Joker to pick up a game-breaking rare is usually correct. The exception is when you have a build that specifically scales with the basic Joker's effect (such as Stuntman)."
  - q: "How often is this tier list updated?"
    a: "We update this tier list after every Balatro patch that touches Joker balance, and we do a full re-evaluation quarterly. The last update was for the 1.0.4 patch."
---
